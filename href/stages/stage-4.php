    ...
    <script>
        ...
        normalAttackBtn.addEventListener('click', () => {
            ...
            setTimeout(() => {
                ...
                if (playerHP <= 0) {
                    ...
                    // Make an AJAX request to stage4-exp.php
                    sendAjaxRequest("../../process/stage4-exp.php");
                }
        ...
        if (shadowStepBtn != null) {
            shadowStepBtn.addEventListener('click', () => {
                ...
                setTimeout(() => {
                    // Enemy attack
                    const enemyDamage = Math.floor(Math.random() * 100) + 1; //enemy damage
                    playerHP -= enemyDamage;
                    if (playerHP < 0) {
                        playerHP = 0;
                    }
        ...
        function sendAjaxRequest(url) {
            ...
            xhr.onreadystatechange = function() {
                if (xhr.readyState === 4 && xhr.status === 200) {
                    log.innerHTML += "You've gain 100 exp";
                }
            };
            xhr.send();
        }
